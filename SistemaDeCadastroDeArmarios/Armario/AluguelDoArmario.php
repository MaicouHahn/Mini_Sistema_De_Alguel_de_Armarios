...
$armario=$conexao->procurarArmarioPorId($_GET['idarmario']);
?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <div class="cardCustomizada">
        ...
        <table align="center">
            <tr>
                <td width="500">
                    <center>
                        <H1>Alugar Armario</H1>
                    </center>
                </td>
            </tr>
            <tr>
                <td width="500">
                    <form class="row g-3" action='ConfirmacaoAluguel.php' method='post'>
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">ID do Armario</label>
                            <input type="text" name='idArmario' class="form-control" value= "<?php echo $armario->getIdArmario(); ?>" >
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Valor</label>
                            <input type="text" name='valorArmario' class="form-control" value= "<?php echo $armario->getValorArmario(); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Posição do Armario</label>
                            <input type="text" name='posicaoArmario' class="form-control" value= "<?php echo $armario->getLinha().$armario->getColuna(); ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Endereço do Armario</label>
                            <input type="text" name='enderecoArmario' class="form-control" value= "<?php echo $armario->getLocalizacaoArmario(); ?>">
                        </div>
                        <div class="col-12">
